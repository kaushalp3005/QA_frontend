...
Save the following images into this folder with these **exact filenames**:

| File | Image | Used for |
|------|-------|----------|
| `company-stamp.png` | Round "Candor Foods Pvt. Ltd. – Navi Mumbai" stamp | Company seal on COA print |
