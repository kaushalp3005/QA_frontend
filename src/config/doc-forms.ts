...
export const DOC_FORMS: Record<string, DocFormConfig> = {
  ...
  preproductioninspection:   { formType: "preproductioninspection",   routeSlug: "preproductioninspection",   label: "Pre-Production Inspection",        docNo: "CFPLA.C6.F.07",  dateField: "inspection_date", listColumns: ["inspection_date", "inspection_time", "warehouse"] },
  ...
  "gmp-ghp-inspection":      { formType: "gmp-ghp-inspection",        routeSlug: "gmp-ghp-inspection",        label: "Monthly GMP & GHP Inspection",     docNo: "CFPLA.C3.F.15",  dateField: "audit_datetime",  listColumns: ["audit_datetime", "auditor_name", "rating", "percentage", "warehouse"] },
